define(["require", "exports", "esri/Map", "esri/views/MapView", "esri/geometry/Point", "esri/layers/FeatureLayer", "esri/layers/GraphicsLayer", "esri/Graphic", "esri/renderers/SimpleRenderer", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleFillSymbol"], function (require, exports, EsriMap, MapView, Point, FeatureLayer, GraphicsLayer, Graphic, SimpleRenderer, SimpleLineSymbol, SimpleFillSymbol) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var afkrUrl = "https://services1.arcgis.com/qN3V93cYGMKQCOxL/arcgis/rest/services/afkar09182018/FeatureServer";
    /*
    ...
    */
    var afkrRenderer = new SimpleRenderer({
        symbol: new SimpleLineSymbol({
            color: [0, 137, 252, 0.6],
            width: 2
        })
    });
    var afkrLayer = new FeatureLayer({
        url: afkrUrl,
        outFields: ["*"],
        visible: true,
        //popupTemplate: fdoPopup,
        renderer: afkrRenderer
    });
    ...
    function queryFdo(myval) {
        var query = afkrLayer.createQuery();
        query.where = myval + " = 'Yes'";
        return afkrLayer.queryFeatures(query);
    }
