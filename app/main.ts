...
const afkrUrl = "https://services1.arcgis.com/qN3V93cYGMKQCOxL/arcgis/rest/services/afkar09182018/FeatureServer";
/*
...
*/      
const afkrRenderer = new SimpleRenderer({
...
const afkrLayer = new FeatureLayer({
  url: afkrUrl,
  outFields: ["*"],
  visible: true,
...
function queryFdo(myval) {
  let query = afkrLayer.createQuery();
